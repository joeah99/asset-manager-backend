    ...
    try:
        ...
        sale_details = [
            SaleDetailResponse(
                ...
                state_tax_on_recapture=sale.state_tax_on_recapture,
                state_tax_on_capital_gain=sale.state_tax_on_capital_gain,
        ...
        response = ScenarioResultsResponse(
            ...
            federal_tax_on_sales=results.federal_tax_on_sales,
            state_tax_on_sales=results.state_tax_on_sales,
            ...
            federal_tax_savings_from_deductions=results.federal_tax_savings_from_deductions,
            state_tax_savings_from_deductions=results.state_tax_savings_from_deductions,
